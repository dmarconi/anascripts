...
setenv_str  = "#!/bin/bash\n"
setenv_str += "\n"
setenv_str += "shopt -s expand_aliases\n"
setenv_str += "\n"
setenv_str += "module ()\n"
setenv_str += "{\n"
setenv_str += "eval `/usr/bin/modulecmd bash $*`\n"
setenv_str += "}\n"
setenv_str += "\n"
setenv_str += "ini ()\n"
setenv_str += "{\n"
setenv_str += "   eval \"`/afs/desy.de/common/etc/local/ini/ini.pl -b $*`\"\n"
setenv_str += "}\n"
...
setenv_str += "module use -a /afs/desy.de/group/cms/modulefiles/\n"
setenv_str += "module load cmssw\n"
setenv_str += "module load crab\n"
